class DbConst {
  ...
  static final colunaQuantidade = "quantidade";
  ...
  get ColunaId => colunaId;

  get ColunaProduto => colunaProduto;

  get ColunaDescricao => colunaDescricao;

  get ColunaQuantidade => colunaQuantidade;

  get ColunaValorUnitario => colunaValorUnitario;

  get ColunaData => colunaData;

  get ColunaDone => colunaDone;
}
